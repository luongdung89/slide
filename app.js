            ...
            slideHtml = `
                <div class="slide-content layout-big-question">
                    ...
                    <div class="bq-wrapper draggable-object">
                        ...
                        <span class="bq-tag"><i class="fa-solid fa-circle-question"></i> ${slide.title}</span>
                    ...
                    <div class="flowchart-container draggable-object">
                        <div class="flowchart-path path-active">
                            ...
                            <div class="flowchart-steps">
                                <div class="fc-step step-teal" contenteditable="true">
                        ...
                        <div class="flowchart-path path-passive" style="margin-top: 20px;">
                            ...
                            <div class="flowchart-steps">
                                <div class="fc-step step-orange" contenteditable="true">
                                    <i class="fa-solid fa-copy"></i>
                                    <span>Chép đáp án</span>
                                </div>
                                <i class="fa-solid fa-arrow-right fc-arrow"></i>
                                <div class="fc-step step-orange" contenteditable="true">
            ...
            slideHtml = `
                <div class="slide-content layout-big-question">
                    ...
                    <div class="bq-wrapper" style="border-color: var(--color-teal);">
                        ...
                        <span class="bq-tag" style="color:var(--color-teal);"><i class="fa-solid fa-circle-question"></i> CÂU HỎI LỚN</span>
                ...
                <div class="sorting-preview">
                    ...
                    <div class="sorting-drag-area">
                        <div class="sorting-pool drop-zone" id="sorting-pool" ondragover="allowDrop(event)" ondrop="dropTag(event)">
                            ${slide.cards.map((card, i) => `<div class="sorting-tag" draggable="true" ondragstart="dragTag(event)" id="tag-${slide.id}-${i}" contenteditable="true">${card}</div>`).join('')}
                        </div>
                    </div>
            ...
            <div class="workspace-wrapper">
                ...
                <div class="workspace-side">
                    ...
                    <div class="workspace-timer-widget" id="timer-widget-${slide.id}" data-duration="${slide.duration || 60}">
                        ...
                        <div class="ws-timer-display" id="timer-display-${slide.id}">00:00</div>
...
window.resetWorkspaceTimer = function(slideId, initialDuration) {
    ...
    if (state) {
        clearInterval(state.intervalId);
        state.intervalId = null;
        state.remainingTime = initialDuration;
        updateTimerDisplay(slideId);
...
// Load offsets and text edits from localStorage on script load
try {
...
function restoreAndSetupDraggables(slideId) {
    ...
    const selectors = [
        '.welcome-badge', '.welcome-title', '.welcome-subtitle', '.welcome-subject', '.welcome-objectives', '.sphere-3d-wrapper',
        '.bq-tag', '.bq-text', '.bq-sub', '.bq-graphic-icon',
        '.role-info-card',
        '.stage-num-badge', '.stage-title', '.stage-lock-icon',
        '.act-intro-card', '.act-intro-icon', '.act-intro-badge', '.act-intro-title', '.act-intro-goal',
        '.prep-box', '.prep-item',
        '.step-item-card',
        '.story-column', '.workspace-questions-card',
        '.mission-envelope-container',
        '.sorting-tag', '.drawing-placeholder', '.workspace-timer-widget',
        '.report-card-item', '.report-highlight-banner',
        '.matrix-cell-label', '.matrix-cell-content',
        '.gf-node',
        '.subject-step-box',
